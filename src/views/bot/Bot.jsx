    ...
    return (
      <ThemeProvider theme={theme}>
        <ChatBot
          ...
          style={styled}
          headerTitle="Cadastre-se, no Hub Ads"
          steps={[
            {
              id: "1",
              delay: 1200,
              message: "Olá! Obrigado pelo interesse no Hub Ads! Qual seu nome?",
              trigger: "nome"
            },
            {
              id: "nome",
            ...
            },
            {
              id: "16",
              delay: 4000,
              message: "Encontrei, no site da Hub, um cadastro com esse cnpj",
              trigger: "review"
            },
            {
              id: 'review',
            ...
            },
            {
              id:"22",
              delay:1000,
              component:(<div><Link to='/'>Acessar Dashboard</Link></div>),
              end:true
            },
          ]}
        />
