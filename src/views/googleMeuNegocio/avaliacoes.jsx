...
class GMBAvaliacoes extends React.Component {
    constructor(props){
        super(props);
    }
        ...
        return (
            <div className="content-header content-ads">
                <div className="container-fluid">
                    ...
                    <div className="row">
                        <div className="col-lg-12 col-md-12 col-sm-12">
                            <h2 className="title-section">Avaliações</h2>
                        </div>
                    </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(GMBAvaliacoes);